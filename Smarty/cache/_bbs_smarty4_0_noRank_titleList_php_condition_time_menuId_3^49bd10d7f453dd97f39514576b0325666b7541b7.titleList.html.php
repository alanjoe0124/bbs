...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_56fe105b8402f3_53095077',
  'has_nocache_code' => true,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56fe105b8402f3_53095077')) {function content_56fe105b8402f3_53095077($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
<html>
    ...
    <tr class="topicsList" align="center">
        ...
        <tr class="topicsList" align="center" >
        <td>
            <a href = "detail.php?titleId=69&menuId=3&page=1">
                gggg
            </a>
        </td>
        <td>
        ...
        <tr class="topicsList" align="center" >
        <td>
            <a href = "detail.php?titleId=66&menuId=3&page=1">
                ha April fool
            </a>
        </td>
        <td>
        ...
        <tr class="topicsList" align="center" >
        <td>
            <a href = "detail.php?titleId=62&menuId=3&page=1">
                haha
            </a>
        </td>
        <td>
        ...
        <tr class="topicsList" align="center" >
        <td>
            <a href = "detail.php?titleId=61&menuId=3&page=1">
                input attack
            </a>
        </td>
        <td>
        ...
        <tr class="topicsList" align="center" >
        <td>
            <a href = "detail.php?titleId=45&menuId=3&page=1">
                2016年2月11日16:50:38
            </a>
        </td>
        <td>
            ...
            <div align="center">
                <div class='page'>
                    ...
                    <span id = "page">1</span>
                                        ...
                                        <a href="titleList.php?menuId=3&page=2&condition=time">2</a> 
                     
                                          
                    
                                        <a href="titleList.php?menuId=3&page=3&condition=time">3</a> 
                     
                                          
                    
                                        <a href="titleList.php?menuId=3&page=4&condition=time">4</a> 
                     
                                        
                     
                    <a href="titleList.php?menuId=3&page=2&condition=time">下一页</a> 
                    <a href="titleList.php?menuId=3&page=4&condition=time">末页</a>
                                    </div>
            </div>
        </td> 
    </tr> 
