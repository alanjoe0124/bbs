...
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'unifunc' => 'content_56fe0e0e56a6b8_32357784',
  'has_nocache_code' => true,
  'cache_lifetime' => 120,
),true); /*/%%SmartyHeaderCode%%*/?>
<?php if ($_valid && !is_callable('content_56fe0e0e56a6b8_32357784')) {function content_56fe0e0e56a6b8_32357784($_smarty_tpl) {?><!DOCTYPE html>
<!--
...
<html>
    ...
    <tr class="topicsList" align="center">
        ...
        <tr class="topicsList" align="center" >
        <td>
            <a href = "detail.php?titleId=47&menuId=3&page=4">
                2016年2月11日17:03:57
            </a>
        </td>
        <td>
        ...
        <tr class="topicsList" align="center" >
        <td>
            <a href = "detail.php?titleId=48&menuId=3&page=4">
                2016年2月11日17:04:12
            </a>
        </td>
        <td>
        ...
        <tr class="topicsList" align="center" >
        <td>
            <a href = "detail.php?titleId=61&menuId=3&page=4">
                input attack
            </a>
        </td>
        <td>
        ...
        <tr class="topicsList" align="center" >
        <td>
            <a href = "detail.php?titleId=62&menuId=3&page=4">
                haha
            </a>
        </td>
        <td>
        ...
        <tr class="topicsList" align="center" >
        <td>
            <a href = "detail.php?titleId=66&menuId=3&page=4">
                ha April fool
            </a>
        </td>
        <td>
        ...
        <td colspan="4" bgcolor="#E6E6FA">
            <div align="center">
                <div class='page'>
                    ...
                    <a href="titleList.php?menuId=3&page=3&condition=">上一页</a> 
